/*! layerå¼¹å±ç»ä»¶æå±ç±» */
;!function(){layer.use("skin/layer.ext.css",function(){layer.layui_layer_extendlayerextjs=!0});var a=layer.cache,b=function(b){return a.skin?" "+a.skin+" "+a.skin+"-"+b:""};
...
//add by wangl  
if(a.formType == 4){
 e = '<select class="layui-layer-input"> <option value="left" ' + (a.value=='left'? 'selected="selected"' : '') +'>居左</option> <option value="center" ' + (a.value=='center'? 'selected="selected"' : '') +'>居中</option> <option value="right" ' + (a.value=='right'? 'selected="selected"' : '') +'>居右</option> </select> ';
}
//end by wangl

//add by houliang  
if(a.formType == 5){
	e = '<select class="layui-layer-input"> <option value="top" ' + (a.value=='top'? 'selected="selected"' : '') +'>顶端对齐</option> <option value="middle" ' + (a.value=='middle'? 'selected="selected"' : '') +'>垂直居中</option> <option value="bottom" ' + (a.value=='bottom'? 'selected="selected"' : '') +'>底端对齐</option> </select> ';
}
//end by houliang
